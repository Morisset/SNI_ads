...
UPDATE: ya encontre una maneja de resolver el problema de los acentos (parcialmente...) y del acceso (se hacen mucho menos peticiones hacia ADS). La liga al program es la misma, verifiquen que es la version 2.4 al inicio del codigo. Verifiqu� que corre bien el PDF. 
...
UPDATE: me contestaron, dandome un truco para reducir las peticiones a ADS. El numero de peticiones a ADS esta limitado a 5000 por d�a. Salió bien para mi, pero a ver con colegas que tienen muchas citas...
